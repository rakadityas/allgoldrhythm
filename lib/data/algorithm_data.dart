          ...
          AlgorithmVisualization(
            ...
            steps: [
              VisualizationStep(
                ...
                previousIndices: [],
                explanation: 'Initialize left pointer at index 0 and right pointer at the last index (index 7).',
              ),
              VisualizationStep(
              ...
              VisualizationStep(
                ...
                previousIndices: [],
                explanation: 'Move right pointer left from index 5 to index 4. Notice that right pointer moved from position 6 to position 5.',
              ),
              VisualizationStep(
                highlightIndices: [4, 4],
                previousIndices: [],
                explanation: 'Move left pointer right from index 3 to index 4. Now both pointers meet at index 4 (position 5). Algorithm terminates.',
              ),
          ...
          AlgorithmVisualization(
            ...
            steps: [
              ...
              VisualizationStep(
                ...
                previousIndices: [],
                explanation: 'Move slow pointer from index 3 to index 4 (position 4 to 5) and fast pointer from index 6 to index 7 (position 7 to 8). Fast pointer has reached the end of the array. Algorithm terminates with slow pointer at index 4 (position 5).',
              ),
            ],
          ),
          AlgorithmVisualization(
            ...
            steps: [
              ...
              VisualizationStep(
                ...
                previousIndices: [],
                explanation: 'Move second pointer from index 6 to index 7 (position 7 to 8). First pointer remains at index 5 (position 6). Algorithm terminates as second pointer reaches the end.',
              ),
            ],
          ),
          AlgorithmVisualization(
            ...
            steps: [
              VisualizationStep(
                highlightIndices: [0, 4, 7],
                previousIndices: [],
                explanation: 'Initialize three pointers: first pointer at index 0 (position 1), second pointer at index 4 (position 5), and third pointer at index 7 (position 8).',
              ),
              VisualizationStep(
                highlightIndices: [0, 3, 7],
                previousIndices: [],
                explanation: 'Move second pointer from index 4 to index 3 (position 5 to 4). First and third pointers remain at indices 0 and 7.',
              ),
              VisualizationStep(
                highlightIndices: [0, 3, 6],
                previousIndices: [],
                explanation: 'Move third pointer from index 7 to index 6 (position 8 to 7). First and second pointers remain at indices 0 and 3.',
              ),
              VisualizationStep(
                highlightIndices: [1, 3, 6],
                previousIndices: [],
                explanation: 'Move first pointer from index 0 to index 1 (position 1 to 2). Second and third pointers remain at indices 3 and 6.',
              ),
              VisualizationStep(
                highlightIndices: [1, 4, 6],
                previousIndices: [],
                explanation: 'Move second pointer from index 3 to index 4 (position 4 to 5). First and third pointers remain at indices 1 and 6.',
              ),
              VisualizationStep(
                highlightIndices: [1, 4, 5],
                previousIndices: [],
                explanation: 'Move third pointer from index 6 to index 5 (position 7 to 6). First and second pointers remain at indices 1 and 4.',
              ),
              VisualizationStep(
                highlightIndices: [2, 4, 5],
                previousIndices: [],
                explanation: 'Move first pointer from index 1 to index 2 (position 2 to 3). Second and third pointers remain at indices 4 and 5.',
              ),
              VisualizationStep(
                highlightIndices: [2, 4, 7],
                previousIndices: [],
                explanation: 'Move third pointer from index 5 to index 7 (position 6 to 8). First and second pointers remain at indices 2 and 4. Algorithm terminates.',
              ),
            ],
          ),
          AlgorithmVisualization(
            ...
            steps: [
              VisualizationStep(
                highlightIndices: [0, 3, 7],
                previousIndices: [],
                explanation: 'Initialize pointers: low at index 0 (position 1), mid at index 3 (position 4), high at index 7 (position 8).',
              ),
              VisualizationStep(
                highlightIndices: [0, 3, 6],
                previousIndices: [],
                explanation: 'Move high pointer from index 7 to index 6 (position 8 to 7). Low and mid pointers remain at indices 0 and 3.',
              ),
              VisualizationStep(
                highlightIndices: [1, 3, 6],
                previousIndices: [],
                explanation: 'Move low pointer from index 0 to index 1 (position 1 to 2). Mid and high pointers remain at indices 3 and 6.',
              ),
              VisualizationStep(
                highlightIndices: [1, 3, 5],
                previousIndices: [],
                explanation: 'Move high pointer from index 6 to index 5 (position 7 to 6). Low and mid pointers remain at indices 1 and 3.',
              ),
              VisualizationStep(
                highlightIndices: [2, 3, 5],
                previousIndices: [],
                explanation: 'Move low pointer from index 1 to index 2 (position 2 to 3). Mid and high pointers remain at indices 3 and 5.',
              ),
              VisualizationStep(
                highlightIndices: [2, 4, 5],
                previousIndices: [],
                explanation: 'Move mid pointer from index 3 to index 4 (position 4 to 5). Low and high pointers remain at indices 2 and 5.',
              ),
              VisualizationStep(
                highlightIndices: [1, 4, 5],
                previousIndices: [],
                explanation: 'Move low pointer from index 2 to index 1 (position 3 to 2). Mid and high pointers remain at indices 4 and 5.',
              ),
              VisualizationStep(
                highlightIndices: [1, 4, 6],
                previousIndices: [],
                explanation: 'Move high pointer from index 5 to index 6 (position 6 to 7). Low and mid pointers remain at indices 1 and 4.',
              ),
              VisualizationStep(
                highlightIndices: [1, 4, 7],
                previousIndices: [],
                explanation: 'Move high pointer from index 6 to index 7 (position 7 to 8). Low and mid pointers remain at indices 1 and 4. Algorithm terminates.',
              ),
            ],
          ),
        ],
          ...
          AlgorithmVisualization(
            ...
            steps: [
              ...
              VisualizationStep(
                ...
                explanation: 'Slide the window by removing index 4 and adding index 7. Window reaches the end of the 8-element array.',
              ),
          ...
          AlgorithmVisualization(
            ...
            steps: [
              ...
              VisualizationStep(
                highlightIndices: [0, 1, 2, 3],
                previousIndices: [],
                explanation: 'Expand the window by adding index 3 (position 4).',
              ),
              VisualizationStep(
              ...
              VisualizationStep(
                ...
                previousIndices: [],
                explanation: 'Slide the window by removing index 2 (position 3) and adding index 6 (position 7).',
              ),
              VisualizationStep(
                highlightIndices: [4, 5, 6, 7],
                previousIndices: [],
                explanation: 'Slide the window by removing index 3 (position 4) and adding index 7 (position 8). Algorithm terminates.',
              ),
            ],
          ),
        ],
